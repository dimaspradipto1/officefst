...
<body onload="window.print()">
    ...
    <table class="letter-header">
        <tr>
            ...
            <td>:</td>
            <td>{{ $surat->kodepro }}/KE/FST-UIS/YAPISTA/{{ $bulanRomawi }}/{{ \Carbon\Carbon::now()->format('Y') }}
            </td>
    ...
    @else
        <div class="content">
            <p>
                Bersama ini kami sampaikan bahwa sehubungan dengan rencana penelitian dalam penyelesaian skripsi
                Mahasiswa,
                untuk itu kami mengharapkan kepada Bapak/Ibu kiranya dapat memberikan izin penelitian pada
                perusahaan/instansi
        ...
        <div class="text" style="text-align: left; margin-top: 20px;">
            ...
            <div
                ...
                <div style="display: flex; align-items: center; text-align: left; margin-top: 80px;">
                    ...
                    <!-- nama dekan -->
                    <div>
                        <p style="margin: 0; font-weight: bold; text-decoration: underline;">Ir. Sanusi, ST., M.Eng.,
                            Ph.D., IPM
                        </p>
                        <p style="margin: 0;">NUP. 7770517640</p>
                    </div>
