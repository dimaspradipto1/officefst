    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Edit Pengguna</h1>
                <p class="mb-0">Perbarui informasi data pengguna yang ada di bawah ini.</p>
            </div>
            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select @error('role') is-invalid @enderror" id="role"
                                            ...
                                            <option value="dekan"
                                                {{ old('role', $user->role) == 'dekan' ? 'selected' : '' }}>Dekan</option>
                                            <option value="wakil_dekan_I"
                                                {{ old('role', $user->role) == 'wakil_dekan_I' ? 'selected' : '' }}>Wakil
                                                Dekan I</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select @error('prodi') is-invalid @enderror" id="prodi"
                                            name="prodi">
                                            <option value="-"
                                                {{ old('prodi', $user->prodi) == '-' ? 'selected' : '' }}>pilih prodi
                                            </option>
                                ...
                                <div class="mb-4 mt-2">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_aktive" id="is_aktive"
                                            value="1"
                                            {{ old('is_aktive', $user->is_aktive) == '1' ? 'checked' : '' }}>
